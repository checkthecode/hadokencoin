...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 21;	// stake age of full weight: 40d
unsigned int nStakeTargetSpacing = 30;			// 30 sec block spacing

int64 nChainStartTime = 1399386939;
...
const string strMessageMagic = "HadokenCoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 25000;	// Height at the end of 5 weeks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HadokenCoin
    bool fStrictPayToScriptHash = true; // Always active in HadokenCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HadokenCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "MAY 6TH, 2014:it was sunny";
        CTransaction txNew;
...
if (true  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("37302246d4cf82224a8508f0e0f1cd010f14c87c4a6ed4266c48ca96758f11fb"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xc5, 0xeb, 0xea };
